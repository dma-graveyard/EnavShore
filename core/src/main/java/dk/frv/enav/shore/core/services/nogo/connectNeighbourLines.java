...
//		  //We have a list of lines, ie. all the lines located at m+1 from original
//		  
...
//		  		
//		  List<List<Point>> possibleNeighbours = connectFindValidNeighbours(line, nextLines);
//		  
//		  
	}
...
//		System.out.println("left end point is: " + selfLeft + " lon is: " + line.get(0).getLon() + " lat is: " + line.get(0).getLat() );
//		System.out.println("right end point is: " + selfRight + " lon is: " + line.get(1).getLon() + " lat is: " + line.get(1).getLat());
		
		//Look at each of the lines in the nextLines list
		for (int i = 0; i < nextLines.size(); i++) {
//			System.out.println("Investigating the line: " + nextLines.get(i));
...
//
//			System.out.println("left end point investigated: " + leftPoint + " lon is: " + nextLines.get(i).get(0).getLon()   + " lat is: " + nextLines.get(i).get(0).getLat());
//			System.out.println("right end point investigated: " + rightPoint + " lon is: " + nextLines.get(i).get(1).getLon()  + " lat is: " + nextLines.get(i).get(0).getLat());
			
			
			//Outward left
			if (leftPoint < selfLeft && ( (rightPoint < selfRight && rightPoint >= selfLeft) || rightPoint >= selfLeft)){
				System.out.println("Outward left neighbour");
				
				NogoPolygon triangle = new NogoPolygon();
				
				//Three nogo points make a triangle
				NogoPoint rightTop = new NogoPoint(line.get(0).getLat() + latOffset, line.get(0).getLon() - lonOffset);
				NogoPoint rightBottom =  new NogoPoint(nextLines.get(i).get(0).getLat() + latOffset, line.get(0).getLon() - lonOffset);
				
				NogoPoint leftBottom = new NogoPoint(nextLines.get(i).get(0).getLat() + latOffset, nextLines.get(i).get(0).getLon() - lonOffset);
			...
			if (leftPoint > selfLeft && leftPoint < selfRight){
				...
				NogoPoint leftTop = new NogoPoint(line.get(0).getLat() - latOffset, line.get(0).getLon() - lonOffset);
				NogoPoint rightTop = new NogoPoint(line.get(0).getLat() - latOffset, nextLines.get(i).get(0).getLon() - lonOffset);
				
				NogoPoint rightBottom =  new NogoPoint(nextLines.get(i).get(0).getLat() - latOffset, nextLines.get(i).get(0).getLon() - lonOffset);
...
//			if (leftPoint < selfLeft && (rightPoint >= selfLeft)){
//				System.out.println("Outward left neighbour");
//				validLines.add(nextLines.get(i));
//			}

			//Not neccessary
//			if (leftPoint < selfLeft && rightPoint == selfRight){
//				System.out.println("Outward left neighbour");
//				validLines.add(nextLines.get(i));
//			}
...
//			
//			if (leftPoint < selfLeft && (rightPoint < selfRight && rightPoint >= selfLeft)){
//				System.out.println("Outward left neighbour");
//				validLines.add(nextLines.get(i));
//			}
//		
